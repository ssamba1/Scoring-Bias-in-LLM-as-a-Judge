...
Every statistic and figure is produced by \path{repro/analyze_peritem.py},
\path{repro/analyze_mechanism.py}, \path{repro/analyze_gold.py},
\path{repro/analyze_robustness.py}, \path{repro/make_mech_figures.py}, and
\path{repro/make_concept_figure.py} from the committed raw files
(\path{results_scaled.json}, \path{gold_results.json}, \path{patch_results.json},
\path{results_multitemplate.json}, \path{attn_results.json},
\path{results_dolly.json.gz}, \path{results_stages.json.gz},
\path{results_probes2.json}, \path{results_closed.json}; collected by the
matching \path{repro/*_harness.py} scripts), seed 42.
