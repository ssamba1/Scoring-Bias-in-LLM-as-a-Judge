...
derived number and figure from the committed raw files, fails if any of them differs
from what is committed, runs the guards and the prose and figure checks, compiles the
paper and rebuilds the submission package. It does not rerun the harnesses; collecting
