...
Every statistic and figure is produced by the fourteen \path{repro/analyze_*.py}
scripts and seven \path{repro/make_*.py} figure generators, from the nineteen
