...
\texttt{results\_dolly.json.gz}, \texttt{results\_stages.json.gz},
\texttt{results\_probes2.json}; collected by
\texttt{repro/\{scaled,gold,patch,multitemplate,attention,dolly,stage,probes2\}\_harness.py}), seed 42.
