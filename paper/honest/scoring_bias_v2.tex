...
\begin{enumerate}\itemsep2pt
  ...
  \item \textbf{Expected-value vs sampled scores.} We read the score distribution
        ...
        judges place on a bare score token is small (much of the numeric mass sits on
        tokenizer variants such as space-prefixed digits), so expected-value scoring
