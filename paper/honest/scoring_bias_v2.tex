...
$0.38$--$0.57$ across all 130 cells), so true first-order sensitivities run at about
...
licenses. Compute is a free tier at zero monetary cost (Appendix~\ref{app:compute}).
...
14B (4-bit), ground-truth, and attention runs $\sim$0.5--1\,h each. The environment is
