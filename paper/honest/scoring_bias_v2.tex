...
confidence cannot. The findings replicate on public-dataset items and in Chinese, and
two preregistered extension probes sharpen the picture: judge-side \emph{sycophancy}
shows the largest tuning effect we measure, while numeric \emph{anchoring} stays
null---tuning inflates responsiveness to social framing, not to every signal. We also
