...
|------|--------|-----------|
| 00:00–00:15 | [Opening: Split screen — on left, a human grading a paper with a red pen; on right, a glowing AI icon grading code] | **Narrator:** "When a human grades a test, we know they can make mistakes. But when an AI judges another AI—can we trust the score?" |
