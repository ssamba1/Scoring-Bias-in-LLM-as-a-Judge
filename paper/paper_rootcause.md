...
Base models show near-zero rubric order bias (mean Δ < 0.1), suggesting that pre-trained models do not spontaneously learn to attend to rubric criterion ordering. Instruct models, having been trained to follow structured instructions, are more sensitive to rubric format—and this sensitivity manifests as bias.
