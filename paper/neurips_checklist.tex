...
\item[{\textbf{4.:}}]
  ...
  \textbf{Justification:} Complete reproduction steps: (1) All code at github.com/ssamba1/research-draft, (2) Kaggle notebook at pipeline_rootcause/study1_full.kaggle.ipynb, (3) Fixed seed=42, temperature=0, (4) Tensor dtypes specified (float16), (5) GPU configuration documented (Kaggle T4, 17GB VRAM).
...
\item[{\textbf{5.:}}]
  ...
  \textbf{Justification:} Complete open-source repository at github.com/ssamba1/research-draft containing all code (MIT license), data (CC-BY 4.0), and detailed reproduction instructions in REPLICATION.md and GETTING_STARTED.md.
