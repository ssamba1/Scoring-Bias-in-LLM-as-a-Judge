...
All code and data are publicly available at \url{https://github.com/ssamba1/research-draft}. The repository includes the complete experiment pipeline, analysis scripts, figures, and paper source. The experiment is fully reproducible at \$0 cost.
...
\label{app:results}
Per-model bias scores, per-probe breakdowns, and item-level analysis are available at \url{https://github.com/ssamba1/research-draft}.
