...
% ── ABSTRACT ──
\begin{abstract}
LLMs are increasingly deployed as automated judges, yet they exhibit systematic scoring biases whose origins remain unknown. We present the first systematic investigation of whether scoring bias originates from pre-training or emerges during instruction tuning. Testing 30 model variants from 15 families across 3 scoring probes (40,500 total judgments), we find that instruction tuning has \emph{differential} effects: format-related biases decrease by 44--77\%, but content-related bias increases by 35\%. This pattern is consistent across all RLHF families and survives Bonferroni correction ($p < 0.017$). We rule out four alternative explanations, propose the IIAR hypothesis with five testable predictions, and demonstrate effective mitigation. The reference answer effect requires cautious interpretation ($p = 0.034$, fails Bonferroni). All code and data are open source at \url{https://github.com/ssamba1/research-draft}.
\end{abstract}
...
The author conceived the study, designed the experiments, ran all model evaluations, performed the analysis, and wrote the manuscript.
...
\bibitem{zheng2023judging} L.~Zheng et al. ``Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena.'' \emph{NeurIPS}, 2023. \href{https://arxiv.org/abs/2306.05685}{arXiv:2306.05685}
\bibitem{li2025scoring} Q.~Li et al. ``Evaluating Scoring Bias in LLM-as-a-Judge.'' \emph{DASFAA}, 2026.
\bibitem{wang2023large} P.~Wang et al. ``Large Language Models are not Fair Evaluators.'' \emph{ACL}, 2024. \href{https://arxiv.org/abs/2305.17926}{arXiv:2305.17926}
\bibitem{ye2024justice} J.~Ye et al. ``Justice or Prejudice? Quantifying Biases in LLM-as-a-Judge.'' \emph{NeurIPS WS}, 2024. \href{https://arxiv.org/abs/2406.06912}{arXiv:2406.06912}
\bibitem{park2024offsetbias} J.~Park et al. ``OffsetBias: Leveraging Debiased Data for Tuning Evaluators.'' \emph{EMNLP Findings}, 2024. \href{https://arxiv.org/abs/2407.01890}{arXiv:2407.01890}
